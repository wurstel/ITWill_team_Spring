...
String content = "<h3>인증하려면 아래 링크를 클릭하세요</h3>" 
					+ "<a href='member_authentication.me?mem_id=" + mem_id + "&mem_auth_code=" + mem_auth_code + "'>인증하기</a>";
...
<body>
	<div align="center">
		<h1>회원 가입을 축하합니다!</h1>
		<input type="button" value="홈으로" onclick="location.href='../main.jsp'"> <!-- main.jsp 로 이동 -->
		<input type="button" value="인증메일보내기" onclick="location.href='mem_sendmail.me?mem_id=<%=mem_id %>&mem_email=<%=mem_email%>'"> <!-- member/mem_loginForm.jsp 로 이동 -->
	</div>
</body>
</html>