...
<body>
	...
	<div style="background: url(resources/assets/standardPage.jpg)" class="jumbotron bg-cover text-white">
    <div class="container py-5 text-center">
        <h1 class="display-4 font-weight-bold">스탠다드 구독</h1>
        <p class="font-italic mb-0">스탠다드 구독 상품은 제철 식품과 시기에 맞춘 컨셉의 밀키트를 제공합니다</p>
