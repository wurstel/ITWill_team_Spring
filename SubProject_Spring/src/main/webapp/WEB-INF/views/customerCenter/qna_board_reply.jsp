...
<jsp:include page="../inc/header.jsp"></jsp:include>
	<main role="main" class="container" style="margin-top: 5em;">
		<form name="QNAReplyForm" method="POST" action="reply.cu">
			...
			<div class="pt-1">
			<input type="text" name="qna_title" value="Re:${qna.qna_title }"
				style="border-radius: 5px; width: 100%; padding: 5px;">
			</div>
			<div class="pt-1">
				<textarea id="summernote" name="qna_content">${qna.qna_content }-------- 원본 글 내용 --------</textarea>
			</div>
			<script>
